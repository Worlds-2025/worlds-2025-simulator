        ...
        <div className="space-y-8">
          ...
          <section className="bg-white rounded-xl shadow-lg p-3 md:p-6 border-2 border-purple-300">
            ...
            <div className="md:hidden mt-6 space-y-6">
              {/* 八强赛抽签 */}
              <div>
                <h3 className="font-bold text-center text-purple-700 mb-3 text-lg">八强赛抽签</h3>
                  ...
                  <div className="bg-blue-50 p-3 rounded-lg border-2 border-blue-300">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="bg-white p-2 rounded border border-blue-200">
                        <div className="text-xs text-center text-gray-600 mb-1">G1</div>
                      ...
                      <div className="bg-white p-2 rounded border border-blue-200">
                        <div className="text-xs text-center text-gray-600 mb-1">G2</div>
                        <div className="text-center text-xs mb-1">
                          <TeamDisplay code={results.top8Seeds[3]} />
                        </div>
                        <div className="text-center text-xs text-gray-400">vs</div>
                  ...
                  <div className="bg-red-50 p-3 rounded-lg border-2 border-red-300">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="bg-white p-2 rounded border border-red-200">
                        <div className="text-xs text-center text-gray-600 mb-1">G3</div>
                        <div className="text-center text-xs mb-1">
                          <TeamDisplay code={results.top8Seeds[1]} />
                        </div>
                        <div className="text-center text-xs text-gray-400">vs</div>
                      ...
                      <div className="bg-white p-2 rounded border border-red-200">
                        <div className="text-xs text-center text-gray-600 mb-1">G4</div>
                        <div className="text-center text-xs mb-1">
                          <TeamDisplay code={results.top8Seeds[2]} />
                        </div>
                        <div className="text-center text-xs text-gray-400">vs</div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-4 rounded-lg border-2 border-purple-400">
                <h3 className="font-bold text-center text-purple-700 mb-3 text-lg">半决赛抽签</h3>
                <div className="grid grid-cols-2 gap-2">
                  <div className="bg-white p-3 rounded-lg border-2 border-blue-300">
                    <div className="text-xs text-center text-gray-600 mb-2">G5 - 上半区</div>
                  ...
                  <div className="bg-white p-3 rounded-lg border-2 border-red-300">
                    <div className="text-xs text-center text-gray-600 mb-2">G6 - 下半区</div>
                    <div className="text-center text-xs text-gray-600">
                      G3 胜者<br/>vs<br/>G4 胜者
                    </div>
                  </div>
              ...
              <div className="bg-gradient-to-br from-yellow-100 to-orange-200 p-4 rounded-lg border-4 border-yellow-500">
                ...
                <div className="text-xs text-center text-gray-600 mt-1">11月9日 · 成都</div>
